...
public class AdministrarLibroController {
    ...
    public void initialize() {
        ...
        SpinnerValueFactory<Integer> valueFactoryEdicion = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, Integer.MAX_VALUE, 1);
        spnEdicion.setValueFactory(valueFactoryEdicion);

        SpinnerValueFactory<Integer> valueFactoryCantidad = new SpinnerValueFactory.IntegerSpinnerValueFactory(0, Integer.MAX_VALUE, 0);
        spnCantidad.setValueFactory(valueFactoryCantidad);

        SpinnerValueFactory<Integer> valueFactoryPublicacion = new SpinnerValueFactory.IntegerSpinnerValueFactory(1900, 2100, 2024);
    ...
    private void agregarEdicion(){
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/vistas/agregarEdicion.fxml"));
    }
}
